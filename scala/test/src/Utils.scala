  ...
  def simulate[T <: RawModule](
    ...
    val sourceFiles = getSourceFiles(sourceDir) ++ {
      if (includeVamsModels) {
        ...
        val defaultModels = Seq("ucie_clk_dist_network.sv", "ucie_clk_div4.v", "ucie_clk_gate.sv", "clkmux.v", "ucie_clkrx.v", "IO_ESD.v", "ucie_esd_routable.v", "ucie_pll.v", "ucie_rst_sync.v")
        Seq(
          disciplines,
          constants,
          controlFile,
