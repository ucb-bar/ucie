...
object SideBandMessage {
  ...
  val REQ_ACTIVE: UInt =
    "b000001".U(D2DAdapterSignalSize.SIDEBAND_MESSAGE_OP_WIDTH)
  ...
  val REQ_LINKRESET: UInt =
    "b001001".U(D2DAdapterSignalSize.SIDEBAND_MESSAGE_OP_WIDTH)
  val REQ_DISABLED: UInt =
    "b001100".U(D2DAdapterSignalSize.SIDEBAND_MESSAGE_OP_WIDTH)
  val RSP_ACTIVE: UInt =
    "b010001".U(D2DAdapterSignalSize.SIDEBAND_MESSAGE_OP_WIDTH)
  val RSP_PMNAK: UInt =
    "b010011".U(D2DAdapterSignalSize.SIDEBAND_MESSAGE_OP_WIDTH)
  ...
  val RSP_LINKRESET: UInt =
    "b011001".U(D2DAdapterSignalSize.SIDEBAND_MESSAGE_OP_WIDTH)
  val RSP_DISABLED: UInt =
    "b011100".U(D2DAdapterSignalSize.SIDEBAND_MESSAGE_OP_WIDTH)
  val ADV_CAP: UInt =
    "b100100".U(D2DAdapterSignalSize.SIDEBAND_MESSAGE_OP_WIDTH)
  val REGISTER_ACCESS: UInt =
    "b101000".U(D2DAdapterSignalSize.SIDEBAND_MESSAGE_OP_WIDTH)
}
