...
module ucie_d2d_dv_top;
  ...
  D2DAdapterDvTop dut (
    ...
    .io_fdi_plRxActiveReq   (fdi.plRxActiveReq),
    .io_fdi_lpRxActiveSts   (fdi.lpRxActiveSts),
    .io_fdi_plProtocol      (fdi.plProtocol),
    .io_fdi_plProtocolFlitFmt (fdi.plProtocolFlitFmt),
    .io_fdi_plProtocolVld   (fdi.plProtocolVld),
    ...
    .io_fdi_lpClkAck        (fdi.lpClkAck),
    .io_fdi_lpWakeReq       (fdi.lpWakeReq),
